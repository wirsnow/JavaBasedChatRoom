...
public class ChatFrame {
    ...
    private static final GridBagLayout gridBagLayout = new GridBagLayout();                  // 创建网格布局
    private static final GridBagConstraints gridBagConstraints = new GridBagConstraints();   // 创建网格约束
    ...
    void initComponents() {
        ...
        // 左侧聊天面板
        {
            ...
            // 设置聊天记录显示框
            {
                ...
                addComponent(messagePanel, messageScrollPane, 0, 0, 1, 1, 1, 1); // 添加组件
            }
            ...
            // 添加工具栏
            {
                ...
                addComponent(messagePanel, toolBar, 0, 1, 1, 1, 1, 0); // 添加组件
            }
            ...
            // 设置文字输入框
            {
                ...
                addComponent(messagePanel, editorScrollPane, 0, 2, 1, 1, 1, 0); // 添加组件
            }
            ...
            //设置发送按钮
            {
                ...
                addComponent(messagePanel, sendButton, 0, 3, 1, 1, 1, 0); // 添加组件
            }
        }
        ...
        // 右侧功能面板
        {
            ...
            if(userName == null){
                ...
                new ChatClientFrame(functionPanel);
            }
        }
     ...
     * @param listener 监听器
     */
    private static void setTLC(JButton button, String Tips, String command, ChatFrameListener listener) {
     ...
     * @param weighty    y方向权重
     */
    private static void addComponent(JPanel jPanel, JComponent component, int gridx, int gridy, int gridwidth, int gridheight, double weightx, double weighty) {
